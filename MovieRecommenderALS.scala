...
object MovieRecommenderALS {
  ...
  def main(args: Array[String]) {
    ...
    //Loading Movie Data
    val movies = spark.read.options(Map("inferSchema"->"true","delimiter"->",", "header"-> "true")).csv("../Data/MovieData/movies.csv").toDF()
    //Loading Rating Data
    val ratings = spark.read.options(Map("inferSchema"->"true","delimiter"->",", "header"-> "true")).csv("../Data/MovieData/ratings.csv").toDF()
    ratings.show()
